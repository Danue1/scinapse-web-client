import { dummy, weightedCitation, strictSort, readLater } from './abTestObject';
...
export type ABTest = 'dummy' | 'weightedCitation' | 'strictSort' | 'readLater';
...
export const LIVE_TESTS: Test[] = [dummy, weightedCitation, strictSort, readLater];
